...
CFLAGS="-Ofast -msse2 -msse4.1 -mfma4 -flto -msha -funroll-loops -fomit-frame-pointer -I./deps/x86_64-w64-mingw32/include -std=c99 -DWIN32 -DCURL_STATICLIB -DPTW32_STATIC_LIB" \
--disable-assembly \
